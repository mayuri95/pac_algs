...
with open(f'hybrid_svm/rice_svm_noise.pkl', 'rb') as f:
...
for mi in mi_range:
    ...
    with open(f'hybrid_svm/rice_acc_mi={mi}.pkl', 'wb') as f:
...
for mi in mi_range:
    ...
    with open(f'hybrid_svm/rice_iso_acc_mi={mi}.pkl', 'wb') as f:
        pickle.dump(acc_dict, f)