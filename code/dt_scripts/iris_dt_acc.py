...
for reg in regs:
    with open(f'hybrid_dt/iris_noise_auto_reg={reg}.pkl', 'rb') as f:
    ...
    for mi in mi_range:
        ...
        with open(f'hybrid_dt/iris_acc_auto_reg={reg}_mi={mi}.pkl', 'wb') as f:
...
for reg in regs:
    ...
    for mi in mi_range:
        ...
        with open(f'hybrid_dt/iris_iso_acc_auto_reg={reg}_mi={mi}.pkl', 'wb') as f:
            pickle.dump(acc_dict, f)
