...
with open(f'hybrid_data/iris_kmeans_hybrid_auto_s=0.5_noise.pkl', 'rb') as f:
    orig_noise = pickle.load(f)[0.5] # keyed by MI, default is 0.5
...
with open(f'hybrid_data/iris_kmeans_acc.pkl', 'wb') as f:
...
for mi in mi_range:
    ...
    acc_dict[mi] = (avg_orig_acc, orig_acc_var, avg_priv_acc, priv_acc_var)
with open(f'hybrid_data/iris_iso_kmeans_acc.pkl', 'wb') as f:
    pickle.dump(acc_dict, f)