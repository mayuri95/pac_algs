...
for rebalance in [True, False]:
    with open(f'hybrid_kmeans/iris_kmeans_hybrid_auto_s=0.5_noise_rebalance={rebalance}.pkl', 'rb') as f:
    ...
    with open(f'hybrid_kmeans/iris_kmeans_acc_bal={rebalance}.pkl', 'wb') as f:
...
for rebalance in [True, False]:
    ...
    for mi in mi_range:
        ...
        acc_dict[mi] = (avg_orig_acc, orig_acc_var, avg_priv_acc, priv_acc_var)
    with open(f'hybrid_kmeans/iris_iso_kmeans_acc_bal={rebalance}.pkl', 'wb') as f:
        pickle.dump(acc_dict, f)