...
for mi in mi_range:
    ...
    for C in C_range:
        ...
        est_noise = det_mechanism_noise(train_x, train_y, run_svm, subsample_rate,
    ...
    with open(f'data_0120/iris_svm_aniso_acc_mi={mi}.pkl', 'wb') as f:
        pickle.dump(iris_acc, f)
        
    with open(f'data_0120/iris_svm_aniso_noise_mi={mi}.pkl', 'wb') as f:
