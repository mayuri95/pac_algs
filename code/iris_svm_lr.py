...
for add_noise in [True]:
    for C_ind, C in enumerate(C_range):
        ...
        for trial_ind in range(num_trials):
            ...
            false_dists = pickle.load(open(f'test_lr_noise/models/iris_svm_ind_C={C}_{test_ind}_mi={mi}_noised_dist.pkl', 'rb'))
            # true positive test
        ...
        with open(f'test_lr_noise/iris_svm_C={C}_mi={mi}_noise={add_noise}_baseline.pkl', 'wb') as f:
