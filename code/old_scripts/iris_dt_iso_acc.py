...
regs = [(0.01, 0., 1.0), (0.01, 0., 0.95), (0.01, 0., 0.9), (0.01, 0.05, 0.95), (0.01, 0.1, 0.95)]
regs = [(None, 0.05, 0.95), (None, 0.05, 0.99)]
regs = [(None, 0, 1.0)]
#regs = [(0.01, 0.68, 0.51)]
#regs = [(None, 0.05, 0.95)]
num_trees = 1
...
for reg in regs:
    ...
    for mi in mi_range:
        ...
        with open(f'hybrid_data/iris_acc_iso_auto_reg={reg}_mi={mi}.pkl', 'wb') as f:
