...
#regularizations = [(0.01, 0., 1.0), (0.01, 0., 0.95), (0.01, 0., 0.9), (0.01, 0.05, 0.95), (0.01, 0.1, 0.95)]
#regularizations = [(None, 0.05, 0.95), (None, 0.05, 0.99), (None, 0.01, 0.99), (None, 0.01, 0.95)]

regularizations = [(None, 0, 1.0), (0.01, 0.1, 0.95)]
num_trees = 1
tree_depth = 3
mi = 0.5
print("DATA LOADED")
...
for reg in regularizations:
    ...
    with open(f'hybrid_data/iris_noise_auto_reg={reg}.pkl', 'wb') as f:
        pickle.dump(noise, f)    
