...
def comp_baseline_acc(tx, ty, num_trials=50):
    avg_orig_acc = 0
    for i in range(num_trials):
        ...
        avg_orig_acc += acc
    return avg_orig_acc / num_trials
...
for reg in regs:
    with open(f'hybrid_data/iris_noise_auto_reg={reg}.pkl', 'rb') as f:
    ...
    for mi in mi_range:
        ...
        with open(f'hybrid_data/iris_acc_auto_reg={reg}_mi={mi}.pkl', 'wb') as f:
...
for reg in regs:
    ...
    for mi in mi_range:
        ...
        with open(f'hybrid_data/iris_iso_acc_auto_reg={reg}_mi={mi}.pkl', 'wb') as f:
            pickle.dump(acc_dict, f)
