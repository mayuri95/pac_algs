...
for mi in mi_range:
    ...
    for C_i, C in enumerate(C_range):
        train_x, train_y, test_x, test_y, num_classes, train_len = gen_bean(normalize=True, norm_kind =norms[C_i])
        with open(f'noise/bean_svm_noise_norm={norms[C_i]}.pkl', 'rb') as f:
    ...
    with open(f'accs/bean_acc_mi={mi}.pkl', 'wb') as f:
...
for mi in mi_range:
    ...
    with open(f'accs/bean_iso_acc_mi={mi}.pkl', 'wb') as f:
        pickle.dump(acc_dict, f)
