...
for rebalance in [False]:
    with open(f'noise/bean_kmeans_hybrid_auto_s=0.5_noise_rebalance={rebalance}.pkl', 'rb') as f:
    ...
    for mi in mi_range:
        ...
        with open(f'accs/bean_kmeans_acc_bal={rebalance}_mi={mi}.pkl', 'wb') as f:
...
for rebalance in [False]:
    ...
    for mi in mi_range:
        ...
        acc_dict[mi] = (avg_orig_acc, orig_acc_var, avg_priv_acc, priv_acc_var)
        with open(f'accs/bean_iso_kmeans_acc_bal={rebalance}_mi={mi}.pkl', 'wb') as f:
            pickle.dump(acc_dict, f)