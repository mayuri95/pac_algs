    ...
    for mi in mi_range:
        for C_ind, C in enumerate(C_range):
            ...
            for trial_ind in range(num_trials):
                ...
                if add_noise:
                    false_dists = pickle.load(open(f'hybrid_lr/models/iris_svm_iso_C={C}_noise={add_noise}_ind_{test_ind}_mi={mi}_dist.pkl', 'rb'))
                else:
                    false_dists = pickle.load(open(f'hybrid_lr/models/iris_svm_iso_C={C}_noise={add_noise}_ind_{test_ind}_dist.pkl', 'rb'))
                # true positive test
            ...
            with open(f'hybrid_lr/iris_svm_iso_C={C}_mi={mi}_noise={add_noise}.pkl', 'wb') as f:
