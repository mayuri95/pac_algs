...
for mi in mi_range:
    ...
    for num_features in test_dims:
        with open(f'data/rice_pca_noise_auto_dim={num_features}.pkl', 'rb') as f:
    ...
    with open(f'data/rice_iso_pca_dist_mi_{mi}.pkl', 'wb') as f:
...
for mi in mi_range:
    ...
    with open(f'data/rice_pca_dist_mi_{mi}.pkl', 'wb') as f:
        pickle.dump(acc_dict, f)
