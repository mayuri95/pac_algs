...
noise_dict = {
    0: 0.006777227646670633, 1: 0.012857448690255915, 2: 0.002018189016268364, 3: 0.0025894333111119725,
    4: 0.01481044097458502, 5: 0.017315603330044955, 6: 0.02293056838668492, 7: 0.02277322803550299,
    8: 0.016238925070297266, 9: 0.008862780822684609, 10: 0.019541618504350298, 11: 0.022417808770088827
}
...
for add_noise in [True, False]:
    for mi in mi_range:
        orig_noise = copy.deepcopy(noise_dict)
        ...
        for trial_ind in range(num_trials):
            ...
            false_dists = pickle.load(open(f'hybrid_data/test_lr_noise/models/iris_kmeans_noise={add_noise}_ind_{test_ind}_mi={mi}_dist.pkl', 'rb'))
            # true positive test
        ...
        with open(f'hybrid_data/iris_iso_kmeans_mi={mi}_noise={add_noise}.pkl', 'wb') as f:
