...
#regs = [(None, 0, 1.0), (0.01, 0.68, 0.51)]
# regs = [(0.01, 0., 1.0), (0.01, 0., 0.95), (0.01, 0., 0.9), (0.01, 0.05, 0.95), (0.01, 0.1, 0.95), (None, 0.05, 0.95), (None, 0.05, 0.99)]
#regs = [(None, 0, 1.0)]
#regs = [(0.01, 0.68, 0.51)]
#regs = [(None, 0.05, 0.95)]
#regs = [(None, 0, 1.0), (0.01, 0.1, 0.95)]
#regs = [(None, 0, 1.0), (0.01, 0.1, 0.95), (0.01, 0.68, 0.51)]
regs = [(0.01, 0.6, 0.35)]
regs = [(0.01, 0.45, 0.8)]
num_trees = 1
tree_depth = 3
...
for reg in regs:
    with open(f'hybrid_data/iris_noise_auto_1e-6_reg={reg}.pkl', 'rb') as f:
    ...
    for mi in mi_range:
        ...
        print(f'iris acc for mi={mi} aniso = {(avg_orig_acc, avg_priv_acc)}')

        with open(f'hybrid_data/iris_acc_auto_1e-6_reg={reg}_mi={mi}.pkl', 'wb') as f:
...
for reg in regs:
    ...
    for mi in mi_range:
        ...
        with open(f'hybrid_data/iris_iso_acc_auto_1e-6_reg={reg}_mi={mi}.pkl', 'wb') as f:
            pickle.dump(acc_dict, f)
