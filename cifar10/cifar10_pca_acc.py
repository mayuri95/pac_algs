...
for iso in [True, False]:
    for mi in mis:
        ...
        for C_i, dim in enumerate(dims):
            with open(f'noise/cifar10_pca_noise_auto_dim={dim}.pkl', 'rb') as f:
                all_noise = pickle.load(f)
            train_x, train_y, test_x, test_y, num_classes, train_len = gen_cifar10(normalize=True, norm_kind =norm)
        ...
        with open(f'accs/cifar10_iso_pca_dist_mi_{mi}.pkl', 'wb') as f:
