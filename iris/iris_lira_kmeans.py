...
for add_noise in [True, False]:
    for mi in mi_range:
        ...
        for trial_ind in range(num_trials):
            ...
            if add_noise:
                false_dists = pickle.load(open(f'hybrid_lr/models/iris_kmeans_noise={add_noise}_ind_{test_ind}_mi={mi}_dist.pkl', 'rb'))
            else:
                false_dists = pickle.load(open(f'hybrid_lr/models/iris_kmeans_noise={add_noise}_ind_{test_ind}_mi_0.0078125_dist.pkl', 'rb'))
            # true positive test
        ...
        with open(f'hybrid_lr/iris_kmeans_mi={mi}_noise={add_noise}.pkl', 'wb') as f:
