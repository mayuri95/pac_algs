...
for norm_ind, norm in enumerate(norms):
    ...
    with open(f'noise/iris_kmeans_hybrid_auto_s=0.5_noise_rebalance={reb}.pkl', 'rb') as f:
    ...
    with open(f'accs/iris_kmeans_acc_bal={reb}.pkl', 'wb') as f:
...
for norm_ind, norm in enumerate(norms):
    ...
    for mi in mi_range:
        ...
        acc_dict[mi] = (avg_orig_acc, orig_acc_var, avg_priv_acc, priv_acc_var)
    with open(f'accs/iris_iso_kmeans_acc_bal={reb}.pkl', 'wb') as f:
        pickle.dump(acc_dict, f)
