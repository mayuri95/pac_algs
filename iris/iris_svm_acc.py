...
norms = ['robust', 'quantile_gaussian']
C_range = [0.05, 1.0]
...
for mi in mi_range:
    ...
    for C_i, C in enumerate(C_range):
        train_x, train_y, test_x, test_y, num_classes, train_len = gen_iris(normalize=True, norm_kind =norms[C_i])
    ...
    with open(f'accs/iris_acc_mi={mi}.pkl', 'wb') as f:
...
for mi in mi_range:
    ...
    with open(f'accs/iris_iso_acc_mi={mi}.pkl', 'wb') as f:
        pickle.dump(acc_dict, f)
